...
class PersonConstructor(val name: String, var age: Int) { //사실 var age: Int =0 이렇게 하면 되서 밑에 constructor는 무쓸모에 가깝다.
    //생성자가 여러개임
    //기본생성자가 있고, 다른 생성자는 기본 생성자를 호출
    // 기본생성자가 매개변수(초기화블럭)가 가장 많음.

    //constructor 을 함수라고 보면 된다
    //이 생성자함수는: 매개변수가 2개인 함수타입
